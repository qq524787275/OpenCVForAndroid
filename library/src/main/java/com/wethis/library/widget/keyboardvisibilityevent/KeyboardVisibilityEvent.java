package com.wethis.library.widget.keyboardvisibilityevent;
...
import com.wethis.library.widget.keyboardvisibilityevent.util.UIUtil;
        ...
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener =
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        //获得屏幕整体的高度
                        int hight = activityRoot.getHeight();
                        //获得键盘高度
                        int keyboardHeight = hight-displayHight- DensityUtils.getStatuBarH(activity);
                        ...
                        wasOpened = isOpen;
                        listener.onVisibilityChanged(isOpen,keyboardHeight);
                    }
                };
